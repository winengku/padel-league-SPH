...
<template>
  <div class="min-h-screen py-10">
    ...
    <div class="text-center">
      <div class="text-xl tracking-wide uppercase">Admin Panel</div>
    </div>

    <!-- COURT TAB -->
    <section class="px-4" style="padding-top: 20px">
    ...
    <!-- LADDERBOARD -->
    <section class="px-4 py-5 space-y-6" style="padding-top: 20px">
      <div
